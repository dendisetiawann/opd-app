            ...
            <aside class="flex flex-col flex-shrink-0 bg-slate-900 dark:bg-zinc-950 border-r border-slate-800 dark:border-zinc-900 transition-all duration-300 ease-in-out transform md:translate-x-0 fixed z-30 h-full"
                    ...
                    <nav class="space-y-1 px-2">
                        ...
                        <a href="{{ route('admin.dashboard') }}" 
                           ...
                           x-tooltip.raw="Dashboard">
                            <i class="fa-solid fa-chart-pie text-lg flex-shrink-0 {{ request()->routeIs('admin.dashboard') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" :class="sidebarCollapsed ? '' : 'mr-3 w-5 text-center'"></i>
                        ...
                        <a href="{{ route('admin.web-apps.index') }}" 
                           ...
                           x-tooltip.raw="Data Aplikasi">
                            <i class="fa-solid fa-layer-group text-lg flex-shrink-0 {{ request()->routeIs('admin.web-apps.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" :class="sidebarCollapsed ? '' : 'mr-3 w-5 text-center'"></i>
                        ...
                        <a href="{{ route('admin.users.index') }}" 
                           ...
                           x-tooltip.raw="Manajemen User">
                            <i class="fa-solid fa-users-cog text-lg flex-shrink-0 {{ request()->routeIs('admin.users.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" :class="sidebarCollapsed ? '' : 'mr-3 w-5 text-center'"></i>
                        ...
                        <!-- Editor Situs -->
                        <a href="{{ route('admin.site-editor.index') }}" 
                           class="group flex items-center px-4 py-3 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('admin.site-editor.*') ? 'bg-gradient-to-r from-blue-800 to-slate-700 dark:to-zinc-800 text-white' : 'text-slate-300 hover:bg-slate-800 dark:hover:bg-zinc-900 hover:text-white' }}"
                           :class="sidebarCollapsed ? 'justify-center px-2' : ''"
                           x-tooltip.raw="Editor Situs">
                            <i class="fa-solid fa-pen-to-square text-lg flex-shrink-0 {{ request()->routeIs('admin.site-editor.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" :class="sidebarCollapsed ? '' : 'mr-3 w-5 text-center'"></i>
                            <span class="transition-all duration-300 whitespace-nowrap overflow-hidden" :class="sidebarCollapsed ? 'w-0 opacity-0' : 'w-auto opacity-100'">Editor Situs</span>
                        </a>

                        <!-- Audit Log -->
                        <a href="{{ route('admin.audit-log.index') }}" 
                           class="group flex items-center px-4 py-3 text-sm font-medium rounded-md transition-colors {{ request()->routeIs('admin.audit-log.*') ? 'bg-gradient-to-r from-blue-800 to-slate-700 dark:to-zinc-800 text-white' : 'text-slate-300 hover:bg-slate-800 dark:hover:bg-zinc-900 hover:text-white' }}"
                           :class="sidebarCollapsed ? 'justify-center px-2' : ''"
                           x-tooltip.raw="Audit Log">
                            <i class="fa-solid fa-clipboard-list text-lg flex-shrink-0 {{ request()->routeIs('admin.audit-log.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" :class="sidebarCollapsed ? '' : 'mr-3 w-5 text-center'"></i>
                            <span class="transition-all duration-300 whitespace-nowrap overflow-hidden" :class="sidebarCollapsed ? 'w-0 opacity-0' : 'w-auto opacity-100'">Audit Log</span>
                        </a>
                        <!-- Monitoring (Dropdown) -->
                        <div x-data="{ open: {{ request()->routeIs('admin.monitoring.*') ? 'true' : 'false' }} }">
                            <button @click="open = !open" 
                                    ...
                                    :class="sidebarCollapsed ? 'justify-center px-2' : ''">
                                <i class="fa-solid fa-chart-line text-lg flex-shrink-0 {{ request()->routeIs('admin.monitoring.*') ? 'text-white' : 'text-slate-400 group-hover:text-white' }}" :class="sidebarCollapsed ? '' : 'mr-3 w-5 text-center'"></i>
                ...
                <div class="border-t border-slate-800 dark:border-zinc-900 bg-slate-950 dark:bg-black transition-all duration-300" :class="sidebarCollapsed ? 'p-1.5' : 'p-3'">
                    ...
                    <button id="adminThemeToggle" type="button" class="w-full flex items-center py-2.5 rounded-xl text-slate-400 hover:text-white hover:bg-slate-800 dark:hover:bg-zinc-900 border border-transparent hover:border-slate-700 dark:hover:border-zinc-800 transition-all duration-200 mb-2" :class="sidebarCollapsed ? 'justify-center px-2' : 'gap-2 px-4'">
                        <i id="adminDarkIcon" class="hidden fa-solid fa-moon text-base"></i>
                        <i id="adminLightIcon" class="hidden fa-solid fa-sun text-base text-amber-400"></i>
