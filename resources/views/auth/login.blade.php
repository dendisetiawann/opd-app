        ...
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-white dark:bg-[#0a0f1a] z-10 relative">
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                ...
                <div class="mb-10">
                    ...
                    <h2 class="text-2xl font-bold tracking-tight text-gray-900">{{ App\Models\SiteSetting::get('login_title', 'Selamat Datang Kembali') }}</h2>
                    <p class="mt-2 text-sm text-gray-500">
                        {{ App\Models\SiteSetting::get('login_description', 'Silahkan masuk ke akun Anda untuk mengakses dashboard manajemen aplikasi.') }}
                    </p>
                </div>
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <button type="button" onclick="refreshCaptcha()" class="text-gray-400 hover:text-blue-600" title="Ganti soal">
                                    <i class="fa-solid fa-rotate w-3.5 h-3.5 flex items-center justify-center"></i>
                                </button>
                            </div>
        ...
        <div class="relative hidden w-0 flex-1 lg:block">
            ...
            <div class="absolute inset-0 flex flex-col justify-center items-center text-white px-12 text-center pointer-events-none">
                <div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/10 shadow-2xl max-w-lg">
                    <h3 class="text-2xl font-bold mb-4">{{ App\Models\SiteSetting::get('login_panel_title', 'Sistem Manajemen Data Aplikasi') }}</h3>
                    <p class="text-blue-100 text-sm leading-relaxed">
                        {{ App\Models\SiteSetting::get('login_panel_description', 'Platform untuk pengelolaan aset digital dan inventarisasi aplikasi di lingkungan Pemerintah Kota Pekanbaru. Mendukung tata kelola SPBE yang lebih baik.') }}
                    </p>
