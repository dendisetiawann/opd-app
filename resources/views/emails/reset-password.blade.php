                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <div style="text-align: center; margin-bottom: 24px;">
                                <span style="display: inline-block; width: 64px; height: 64px; background: linear-gradient(135deg, #fef3c7, #fde68a); border-radius: 50%; line-height: 64px; font-size: 32px;">🔒</span>
                            </div>

                            <h2 style="margin: 0 0 16px; color: #1e293b; font-size: 20px; font-weight: 700; text-align: center;">Reset Password</h2>
                            
                            <p style="margin: 0 0 28px; color: #6b7280; font-size: 14px; line-height: 1.7; text-align: center;">
                                Kami menerima permintaan untuk mengatur ulang password akun Anda di <strong>Sistem Manajemen Data Aplikasi OPD</strong>.
                            </p>
                            
                            <!-- Reset Button -->
                            <div style="text-align: center; margin-bottom: 28px;">
                                <a href="{{ $url }}" style="display: inline-block; padding: 14px 40px; background: linear-gradient(135deg, #1e40af, #3b82f6); color: #ffffff; text-decoration: none; border-radius: 12px; font-size: 15px; font-weight: 700; letter-spacing: 0.5px; box-shadow: 0 4px 14px rgba(59, 130, 246, 0.4);">
                                    Atur Ulang Password
                                </a>
                            </div>
                            ...
                            <div style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 12px; padding: 14px 18px; margin-bottom: 28px; text-align: center;">
                                <p style="margin: 0; color: #0369a1; font-size: 13px;">
                                    ⏱️ Link ini akan kedaluwarsa dalam <strong>5 menit</strong>.
                                </p>
                            </div>
