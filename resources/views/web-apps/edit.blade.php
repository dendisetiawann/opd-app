                    ...
                    <div class="relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="deskripsi_singkat" name="deskripsi_singkat" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm transition-all" required placeholder="Jelaskan fungsi utama aplikasi ini...">{{ old('deskripsi_singkat', $webApp->deskripsi_singkat) }}</textarea>
                    ...
                    <div class="relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea id="data_tim_programmer" name="data_tim_programmer" rows="3" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm" required placeholder="Sebutkan nama programmer...">{{ old('data_tim_programmer', $webApp->data_tim_programmer) }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2">
                                ...
                                <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 mt-1">
                                    <textarea id="bahasa_pemrograman" name="bahasa_pemrograman" rows="3" class="block w-full bg-transparent border-0 focus:ring-0 p-0 text-sm" required placeholder="Contoh: PHP versi 8.2 dan TypeScript versi 5">{{ old('bahasa_pemrograman', $webApp->bahasa_pemrograman) }}</textarea>
                                </div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="daftar_library_package" name="daftar_library_package" rows="2" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-xl shadow-sm" required placeholder="Contoh: Spatie Permission, Guzzle, LeafletJS">{{ old('daftar_library_package', $webApp->daftar_library_package) }}</textarea>
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                    <div class="relative">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-4">
                                    <label class="group relative flex items-center gap-3 p-3 rounded-xl border border-slate-200 cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 transition-all">
                                        <input type="radio" name="has_repository" value="ya" required class="w-4 h-4 text-indigo-600 border-slate-300 focus:ring-indigo-500" {{ $hasRepo == 'ya' ? 'checked' : '' }} onchange="toggleRepositoryStatus()">
                                        <span class="text-sm font-bold text-slate-700">Ya, Ada</span>
                                    </label>
                                    <label class="group relative flex items-center gap-3 p-3 rounded-xl border border-slate-200 cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 transition-all">
                                        <input type="radio" name="has_repository" value="tidak" required class="w-4 h-4 text-indigo-600 border-slate-300 focus:ring-indigo-500" {{ $hasRepo == 'tidak' ? 'checked' : '' }} onchange="toggleRepositoryStatus()">
                            ...
                            <!-- Repo Details -->
                            <div id="repository_status_wrapper" class="{{ $hasRepo == 'ya' ? '' : 'hidden' }} pl-4 border-l-2 border-indigo-100 space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 mt-1">
                                    <textarea id="metode_monitoring_evaluasi" name="metode_monitoring_evaluasi" rows="3" class="block w-full bg-transparent border-0 focus:ring-0 p-0 text-sm" placeholder="Contoh: Google Analytics, Uptime Robot, Feedback Pengguna...">{{ old('metode_monitoring_evaluasi', $webApp->metode_monitoring_evaluasi) }}</textarea>
                                </div>
