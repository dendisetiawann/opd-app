                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="jenis_aplikasi" name="jenis_aplikasi" class="block mt-1 w-full border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-slate-900 dark:text-slate-100 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-xl shadow-sm text-sm">
                                    ...
                                    <option value="Desktop Application" {{ old('jenis_aplikasi') == 'Desktop Application' ? 'selected' : '' }}>Desktop Application</option>
                                </select>
                    ...
                    <div class="relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="md:col-span-2" x-data="languageSelector()" x-init="init()">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div x-show="langOpen && (langResults.length > 0 || (langSearch && !langExactMatch))"
                                                ...
                                                <div 
                                                    ...
                                                    :class="{ 'bg-emerald-50 dark:bg-emerald-900/20': langHighlightedIndex === langResults.length, 'hover:bg-emerald-50/50 dark:hover:bg-emerald-900/10': langHighlightedIndex !== langResults.length }">
                                            ...
                                            <div x-show="versiLangOpen && (versiLangResults.length > 0 || (versiLangSearch && !versiLangExactMatch))"
                                                ...
                                                <template x-for="(versi, index) in versiLangResults" :key="versi">
                                                    <div @click="selectVersiLang(versi)"
                                                        ...
                                                        :class="{ 'bg-cyan-50 dark:bg-cyan-900/30': versiLangHighlightedIndex === index, 'hover:bg-gray-50 dark:hover:bg-zinc-700/50': versiLangHighlightedIndex !== index }">
                                ...
                                <!-- Alpine.js Component Script for Language -->
                                <script>
                            ...
                            <div class="md:col-span-3" x-data="frameworkSelector()" x-init="init()">
                                ...
                                <!-- Alpine.js Component Script for Framework -->
                                <script>
                                    function frameworkSelector() {
                                        return {
                                            ...
                                            init() {
                                                // Watch perubahan framework untuk reset versi
                            ...
                            <div class="md:col-span-2" x-data="librarySelector()" x-init="init()">
                                ...
                                <div class="bg-violet-50/50 dark:bg-violet-900/20 p-4 rounded-xl border border-violet-100 dark:border-violet-800/30 mt-1 transition-all duration-300">
                                    ...
                                    <div x-show="showGuide" x-collapse
                                        ...
                                        <div class="space-y-3 text-xs text-gray-700 dark:text-gray-300">
                                            ...
                                            <div class="flex items-start gap-2">
                                                <span class="flex-shrink-0 w-5 h-5 rounded-full bg-violet-500 text-white flex items-center justify-center text-[10px] font-bold mt-0.5">2</span>
                                                <div>
                                                    <span>Ketik atau pilih versi di kolom <strong>"Versi"</strong>. Contoh:</span>
                                                    <div class="mt-1.5 flex items-center gap-1.5">
                                                        <span class="inline-flex items-center px-2.5 py-1 rounded-lg bg-white dark:bg-zinc-800 border border-gray-300 dark:border-zinc-600 text-[11px] text-gray-400 italic">6.x...</span>
                                                        <span class="text-gray-400">→</span>
                                                        <span class="inline-flex items-center px-2 py-0.5 rounded bg-violet-100 dark:bg-violet-900/40 text-violet-700 dark:text-violet-300 text-[11px] font-medium">6.x</span>
                                                    </div>
                                                    <p class="mt-1 text-[11px] text-gray-500 dark:text-gray-400">Pilih dari daftar atau ketik manual lalu klik <strong class="text-emerald-600 dark:text-emerald-400">"Tambah Versi"</strong>. Library otomatis masuk ke daftar setelah versi dipilih.</p>
                                                </div>
                                            </div>
                                            <div class="flex items-start gap-2">
                                                <span class="flex-shrink-0 w-5 h-5 rounded-full bg-emerald-500 text-white flex items-center justify-center text-[10px] font-bold mt-0.5">3</span>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="relative">
                                                <input type="text"
                                                    ...
                                                    :placeholder="selectedLib ? selectedLib : 'Cari atau tambah library...'"
                                                    autocomplete="off"
                                                >
                                                <!-- Clear Button -->
                                            ...
                                            <div x-show="libOpen && (libResults.length > 0 || (libSearch && !libExactMatch))"
                                                ...
                                                <!-- Already Added Warning -->
                                                <div 
                                                    x-show="libSearch && addedLibs.some(l => l.name.toLowerCase() === libSearch.toLowerCase())"
                                                    class="px-4 py-3 border-t border-gray-200 dark:border-zinc-600">
                                                    <div class="flex items-center gap-2 text-red-500 dark:text-red-400">
                                                        <i class="fa-solid fa-circle-exclamation w-4 h-4 flex-shrink-0"></i>
                                                        <span class="text-xs font-medium"><span x-text="libSearch"></span> sudah ditambahkan — Pilih library lain</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        >
                                            ...
                                            <div class="relative">
                                                <input type="text"
                                                    ...
                                                    class="block w-full rounded-xl border-gray-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-slate-900 dark:text-slate-100 focus:border-violet-500 dark:focus:border-violet-600 focus:ring-violet-500 dark:focus:ring-violet-600 shadow-sm text-sm py-2.5 px-3"
                                                    :class="{ 'bg-gray-50 dark:bg-zinc-800': selectedVersiLib }"
                                                    :placeholder="selectedVersiLib ? selectedVersiLib : (selectedLib ? 'Cari atau tambah versi ' + selectedLib + '...' : 'Cari atau tambah versi...')"
                                                    autocomplete="off"
                                            ...
                                            <div x-show="versiLibOpen && (versiLibResults.length > 0 || (versiLibSearch && !versiLibExactMatch))"
                                                ...
                                                <template x-for="(versi, index) in versiLibResults" :key="versi">
                                                    <div @click="selectVersiLib(versi)"
                                                        class="px-4 py-2.5 cursor-pointer transition-all duration-150 flex items-center gap-3"
                                                        :class="{ 'bg-violet-50 dark:bg-violet-900/30': versiLibHighlightedIndex === index, 'hover:bg-gray-50 dark:hover:bg-zinc-700/50': versiLibHighlightedIndex !== index }">
                                                        <span class="flex-shrink-0 w-7 h-7 rounded-md bg-violet-100 dark:bg-violet-900/40 flex items-center justify-center">
                                                            <span class="text-violet-700 dark:text-violet-400 text-xs font-semibold" x-text="versi"></span>
                                                        </span>
                                                        <span class="text-sm text-slate-700 dark:text-slate-300" x-text="versi"></span>
                                                    </div>
                                                </template>
                                ...
                                <!-- Alpine.js Component Script for Library -->
                                <script>
                                    function librarySelector() {
                                        return {
                                            ...
                                            updateLibValue() {
                                                this.libValue = this.addedLibs.map(l => l.name + ' ' + l.version).join(', ');
                                            },
                ...
                <div class="bg-white dark:bg-zinc-900/50 rounded-xl p-6 shadow-sm border border-slate-200 dark:border-zinc-800 backdrop-blur-sm">
                    <div class="relative">
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Repo Details -->
                            <div id="repository_status_wrapper" class="hidden pl-4 border-l-2 border-indigo-100 dark:border-indigo-900 space-y-4">
                    ...
                    <div class="relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="relative">
                                ...
                                <input type="hidden" name="dbms" x-model="dbmsValue">
                            ...
                            <div class="relative" x-show="selectedDbms || isNewDbms" x-transition>
                                ...
                                <input type="hidden" name="versi_dbms" x-model="versiValue">
                    ...
                    <script>
                        function dbmsSelector() {
                            return {
                                ...
                                init() {
                                    // Watch perubahan DBMS untuk reset versi
                                    this.$watch('selectedDbms', (value) => {
                                        if (value) {
                                            this.clearVersi();
                                ...
                                normalizeDbmsName(name) {
                                    // Normalisasi nama DBMS: Title Case + DB suffix jika perlu
                                    // Contoh: "cockroach" → "Cockroach", "cockroachdb" → "CockroachDB", "POSTGRESQL" → "Postgresql"
                                    const trimmed = name.trim();
                                    if (!trimmed) return '';
                                    ...
                                    // Generic Title Case untuk yang lain
                                    // Contoh: "custom database" → "Custom Database"
                                    return trimmed
                                        .toLowerCase()
                                        .split(/[\s\-_]+/)
                                        .map(word => word.charAt(0).toUpperCase() + word.slice(1))
                                ...
                                selectNewDbms() {
                                    ...
                                    this.dbmsSearch = normalized; // Update input dengan nama normalized
                                    this.dbmsOpen = false;
                                    this.dbmsHighlightedIndex = -1;
                                    // Kosongkan versi untuk DBMS baru
                                    this.versiResults = [];
                                },
                                ...
                                normalizeVersion(version) {
                                    ...
                                    // Menangani berbagai format versi agar konsisten
                                    ...
                                    const isYearVersion = /^\d{4}$/.test(normalized);           // 2022, 2019
                                    const isOracleVersion = /^\d+c$/i.test(normalized);         // 19c, 21c
                                    const isSemver = /^\d+(\.\d+)*$/.test(normalized);         // 8, 8.0, 8.0.1
                                    
                                    // STEP 4: Normalisasi berdasarkan tipe
                                    
                                    // Kasus 1: SQL Server style (tahun)
                                    if (isYearVersion) {
                                        // 2022, 2019, 2017 → tetap
                                        return normalized;
                                    }
                                    
                                    // Kasus 2: Oracle style (19c, 21c)
                                    if (isOracleVersion) {
                                        // 19c, 21C → 19c, 21c (lowercase c)
                                        return normalized.toLowerCase();
                                    }
                                    
                                    // Kasus 3: Semver (8, 8.0, 8.0.0)
                                    if (isSemver) {
                                        // Hapus leading zeros: 08 → 8, 08.09 → 8.9
                                        normalized = normalized.replace(/\b0+(\d)/g, '$1');
                                        
                                        // Normalisasi tier:
                                        // "8" → "8.0" (angka tunggal jadi x.y)
                                        if (/^\d+$/.test(normalized)) {
                                            normalized = normalized + '.0';
                                        }
                                        
                                        // "8.0.0" → "8.0" (hapus .0 akhir)
                                        // "8.1.0" → "8.1" (hapus .0 akhir)
                                    ...
                                    // Kasus 4: Format lain (beta, rc, dll)
                                    // "1.0-beta" → "1.0-beta" (tetap, hanya lowercase)
                                    return normalized.toLowerCase();
                                },
